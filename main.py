...
def defence(char_name: str, char_class: str) -> str:
    """Функция работы защиты."""
    if char_class == 'warrior':
        defence_value = 10 + randint(5, 10)
        return (f'{char_name} блокировал {defence_value} ед. урона')
    if char_class == 'mage':
...
def special(char_name: str, char_class: str) -> str:
    """Функция работы специальных умений."""
    if char_class == 'warrior':
        special_value = 80 + 25
        return (f'{char_name} применил специальное умение '
                f'«Выносливость {special_value}»')
    if char_class == 'mage':
        special_value = 5 + 40
        return (f'{char_name} применил специальное умение '
                f'«Атака {special_value}»')
    if char_class == 'healer':
        special_value = 10 + 30
        return (f'{char_name} применил специальное умение '
